...
public partial class App : Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        try
        {
            ...
            services.AddSingleton<IBinaryProcessRunner, BinaryProcessRunner>();
            ...
            services.AddSingleton<AdbDevicesParser>();
            services.AddSingleton<IAdbPathDiscovery, AdbPathDiscovery>();
            services.AddSingleton<ILocalAdbEndpointEvidenceProvider, WindowsLocalAdbEndpointEvidenceProvider>();
            services.AddSingleton<IAndroidTargetClassifier, AndroidTargetClassifier>();
            services.AddSingleton<AndroidAdbDeviceService>();
            services.AddSingleton<IAndroidAdbDeviceService>(provider => provider.GetRequiredService<AndroidAdbDeviceService>());
            services.AddSingleton<IAndroidAdbTransportService>(provider => provider.GetRequiredService<AndroidAdbDeviceService>());
            services.AddSingleton<IAndroidAdbStateProbe>(provider => provider.GetRequiredService<AndroidAdbDeviceService>());
            services.AddSingleton<IAndroidScreenshotCaptureService, AndroidScreenshotCaptureService>();
            services.AddSingleton<AndroidLauncherApplicationParser>();
            services.AddSingleton<AndroidForegroundActivityParser>();
            services.AddSingleton<AndroidApplicationService>();
            services.AddSingleton<IAndroidApplicationService>(provider => provider.GetRequiredService<AndroidApplicationService>());
            services.AddSingleton<IAndroidForegroundApplicationService>(provider => provider.GetRequiredService<AndroidApplicationService>());
            ...
            services.AddSingleton<IAndroidApplicationLibraryTransferService, JsonAndroidApplicationLibraryTransferService>();
            ...
            services.AddSingleton<IAndroidApplicationPickerService, AndroidApplicationPickerService>();
            services.AddSingleton<IAndroidDeviceAliasDialogService, AndroidDeviceAliasDialogService>();
            ...
            services.AddSingleton<IAndroidCoordinateCaptureDialogService, AndroidCoordinateCaptureDialogService>();
